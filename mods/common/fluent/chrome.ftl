...
label-mouse-control-desc-touch-selection = - Select units using a <single tap> (Left click)
label-mouse-control-desc-touch-commands = - Command units using a <single tap> (Left click)
label-mouse-control-desc-touch-orders = - Confirm orders using a <single tap> (Left click)
label-mouse-control-desc-touch-buildings = - Place structures using a <single tap> (Left click)
label-mouse-control-desc-touch-support = - Target support powers using a <single tap> (Left click)
label-mouse-control-desc-touch-zoom = - Zoom with a <three-finger swipe> up (in) or down (out)
label-mouse-control-desc-touch-zoom-modifier = - Zoom with a <three-finger swipe> up / down
label-mouse-control-desc-touch-scroll-right = - Pan using <hold then drag> or <two-finger drag>
label-mouse-control-desc-touch-scroll-middle = - Pan using <hold then drag> or <two-finger drag>
label-mouse-control-desc-touch-edgescroll = or by moving to the edge of the screen
label-mouse-control-desc-touch-box = - Box-select with a <quick drag> (before hold delay)
label-mouse-control-desc-touch-double = - Select all of a type using a <double tap>
label-mouse-control-desc-touch-alternate = - Cancel / right-click with a <two-finger tap> or <long press>
